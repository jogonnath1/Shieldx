...
import 'package:shieldx/admin/providers/admin_sos_provider.dart';
            ...
            ...emergencies.map((emergency) {
              ...
              return Container(
                ...
                child: ClipRRect(
                            ...
                            ElevatedButton.icon(
                              onPressed: () async {
                                ...
                                try {
                                  ...
                                  ref.invalidate(
                                      activeEmergenciesStreamProvider);
                                  if (!context.mounted) return;
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                  ...
                  .shimmer(
                      color: const Color(0xFFFF8A8A).withValues(alpha: 0.18),
                      duration: 2.seconds)
                  .fadeIn(
                      begin: 0.65, duration: 1.seconds, curve: Curves.easeInOut)
                  .animate()
