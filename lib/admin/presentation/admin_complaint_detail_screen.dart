...
import 'package:shieldx/common/providers/chat_provider.dart';
...
import 'package:shieldx/common/presentation/widgets/common/evidence_item_widget.dart';
                ...
                : TabBarView(
                    ...
                    children: [
                      ...
                      _ManageTab(
                        ...
                        officers:
                            ref.watch(activeOfficersProvider).valueOrNull ?? [],
...
class _DetailsTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final matchedProfile = complaint.userId != null
        ? profiles
            .cast<ProfileModel?>()
            .firstWhere((p) => p?.id == complaint.userId, orElse: () => null)
        : null;
                ...
                if (!complaint.isAnonymous) ...[
                  ...
                  if (complaint.profession != null)
                    InfoTile(
                        ...
                        label: 'Profession',
                        value: complaint.profession!),
                  if (complaint.presentAddress != null)
                    InfoTile(
                        icon: Icons.location_on_outlined,
                        label: 'Present Address',
                        value: complaint.presentAddress!),
                ],
              ],
            ),
                ...
                children: [
                  Text('Evidence',
                      style: Theme.of(context)
                          ...
                          ?.copyWith(fontWeight: FontWeight.w700)),
                  const SizedBox(height: 12),
                  ...complaint.evidenceUrls.asMap().entries.map((entry) {
                    final index = entry.key;
                    final url = entry.value;
                    return EvidenceItemWidget(originalUrl: url, index: index);
                  }),
                ],
              ),
              ...
              children: [
                ...
                if (officers.isNotEmpty)
                  DropdownButtonFormField<String>(
                    ...
                    dropdownColor: AppColors.card,
                    decoration:
                        const InputDecoration(labelText: 'Assign Officer'),
                    items: [
