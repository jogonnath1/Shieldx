...
class AppColors {
  AppColors._();
  static const Color primary = Color(0xFF165EB6);
  static const Color primaryLight = Color(0xFF4A8BDE);
  static const Color primaryDark = Color(0xFF0B3B73);
  ...
  static const LinearGradient primaryGradient = LinearGradient(
    ...
    colors: [Color(0xFF165EB6), Color(0xFF0B3B73)],
  );
  ...
  static const LinearGradient accentGradient = LinearGradient(
    ...
    colors: [Color(0xFF00BFA5), Color(0xFF165EB6)],
  );
