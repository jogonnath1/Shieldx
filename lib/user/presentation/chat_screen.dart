...
import 'package:shieldx/common/data/services/message_service.dart';
import 'package:shieldx/common/data/models/message_model.dart';
...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  Future<void> _markMessagesAsRead() async {
    ...
    if (currentUser != null) {
      try {
        debugPrint(
            'MARK AS READ: marking messages for complaint ${widget.complaintId} by user ${currentUser.id}');
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    message.sentAt != null
                        ? DateFormat('hh:mm a')
                            .format(message.sentAt!.toBangladeshTime())
                        : '',
                    style: GoogleFonts.inter(
                        fontSize: 10,
