                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_complaint!.evidenceUrls.isNotEmpty) ...[
                          const SizedBox(height: 16),
                          GlassCard(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                ..._complaint!.evidenceUrls.asMap().entries.map((entry) {
                        ...
                        GradientButton(
                          ...
                          onTap: () => context.push('/chat/${_complaint!.id}'),
                ...
                Text(
                  history.changedAt != null
                      ? DateFormat('dd MMM yyyy, hh:mm a')
                          .format(history.changedAt!.toBangladeshTime())
                      : '',
                  style: GoogleFonts.inter(
