...
The following shows the actual folder layout of the ShieldX Flutter project inside \texttt{lib/}. The project contains \textbf{89 Dart source files} organized across \textbf{20 directories}.
\begin{footnotesize}
\begin{verbatim}
lib/
