...
\begin{titlepage}
    \begin{center}
        {\fontsize{22}{26}\bfseries\selectfont ShieldX - Crime Reporting Portal Management System}\\[1.5cm]
        ...
        \includegraphics[width=3.5cm]{lu_logo.png}\\[0.1cm]
        {\small\bfseries estd. 2001}\\[0.1cm]
        {\small\scshape LEADING UNIVERSITY}\\[1.5cm]
        
        {\large\selectfont B.Sc. Project in Computer Science and Engineering}\\[0.5cm]
        {\large\selectfont Supervisor at CSE-LU: Shahriar Arefin Zummon}\\[1.5cm]
        ...
        {\large\selectfont BANGLADESH}\\[1cm]
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{er_diagram_database.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{dfd_level_0.png}
